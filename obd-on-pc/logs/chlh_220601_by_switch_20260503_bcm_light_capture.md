...
Started: `2026-05-03T20:57:15.523`
Last updated: `2026-05-03T21:01:50.651`
Run id: `chlh_220601_by_switch_20260503`
Completed: `True`
Interrupted: `False`
...
- States: `switch_left, switch_middle, switch_right, right_pull_once, right_pull_twice, middle_left_turn, middle_right_turn`
- Repeats: `1`
- Raw CAN window: `0 ms`
...
|---|---:|---|---:|---|
| `switch_middle` | 1 | `positive` | 4 | `6206011E` |
| `switch_right` | 1 | `positive` | 4 | `6206011E` |
| `middle_right_turn` | 1 | `positive` | 4 | `6206011E` |
