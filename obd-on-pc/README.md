...
```text
carista_apk_analysis/carista_android_analysis_notes.md
carista_apk_analysis/carista_tp20_research_update.md
carista_apk_analysis/carista_relevant_evidence.md
carista_apk_analysis/carista_tp20_candidate_strings.txt
```
...
obd-on-pc/prepare_pq25_coding_change.py
obd-on-pc/write_pq25_longcoding.py
obd-on-pc/pq25_longcoding_change_plan.md
obd-on-pc/pq25_bcm_6R0937087K_longcoding_report.md
```
...
- removed the older duplicated `carista_collect` mode; use `run_next_car_probe.ps1` for the focused field run
...
baseline `220600` capture, followed by the automatic decoded settings report
written by `run_next_car_probe.ps1`.
