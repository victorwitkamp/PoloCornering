...
| `car_setting_cornering_lights_via_fogs_experimental` | Official x86 6R/PQ25 branch: `0x012da0f2 -> 0x0135eaf0 VagUdsCodingSetting`, whitelist `CENTRAL_ELEC_6R_5C_7E_7H`, byte/mask `15/80`; `YES_NO` maps no=`00`, yes=`01` | Latest retained 2026-05-08 coding byte `15` is `82`, so mask `80` is set while behavior was still absent. |
| `car_setting_cornering_lights_with_turn_signals` | Official x86 explicit turn-signal key: `0x012da761 -> 0x0135e920 VagUdsCodingSetting`, whitelist `CENTRAL_ELEC_6R_5C_7E_7H_EXP_1S`, byte/mask `15/04`; `YES_NO` maps no=`00`, yes=`01` | Latest retained 2026-05-08 coding byte `15` is `82`, so mask `04` is clear; full expert backup sets it to byte `86`. Treat it as the blinker-trigger enable, not as a front-fog/low-beam output-role selector. |
...
| `car_setting_turn_off_fogs_with_high_beam` | Official x86 6R/PQ25 branch: `0x012d4dea -> 0x0135e580 VagUdsCodingSetting`, whitelist `CENTRAL_ELEC_6R_5C_7E_7H`, byte/mask `15/20`; `YES_NO` maps no=`00`, yes=`01` | Latest retained 2026-05-08 coding byte `15` is `82`, so mask `20` is clear; older byte `A6` state had it set. |
