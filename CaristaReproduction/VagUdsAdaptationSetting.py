...
def car_setting_cornering_lights_via_fogs_left() -> VagUdsAdaptationSetting:
    return VagUdsAdaptationSetting(
        ...
        proof_notes=(
            ...
            "Direct Play 9.8.3 x86 ELF audit shows the same left key also has non-type-7 branches: 0x012da25a -> 0x0136c910 -> VagCanLongCodingSetting/MultipleChoiceInterpretation and 0x012da39a -> 0x01356f90 -> VagUdsAdaptationSetting-neighborhood wrapper.",
...
def car_setting_cornering_lights_via_fogs_right() -> VagUdsAdaptationSetting:
    return VagUdsAdaptationSetting(
        ...
        native_constructor="VagUdsAdaptationSetting(VagUdsEcu, StringWhitelist, rawAddress, valueOffset, mask, key, MultipleChoiceInterpretation)",
        native_source="Older ARM instruction-window recovery plus one official Play 9.8.3 x86 UDS-adaptation same-key helper; branch unresolved",
        ...
        proof_notes=(
            ...
            "Direct Play 9.8.3 x86 ELF audit shows mixed same-key branches: 0x012da5a9 -> 0x01368690 -> VagUdsAdaptationSetting/NumericalInterpretation and 0x012da6e9 -> 0x0136caf0 -> VagUdsAdaptationSetting-neighborhood wrapper.",
