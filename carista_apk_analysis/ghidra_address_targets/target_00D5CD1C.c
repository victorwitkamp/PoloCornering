/* Target address 00d5cd1c */
/* Function StringWhitelist @ 00d5cd1c */
...
void __thiscall StringWhitelist::StringWhitelist(StringWhitelist *this,vector *param_1)

{
  ...
  local_20 = 0;
  uStack_1c = 0;
  StringWhitelist(this,param_1,(vector *)&local_20);
