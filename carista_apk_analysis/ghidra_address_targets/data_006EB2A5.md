# Data Target `006eb2a5`

## Symbols
- `Label` `s_1S0937087*_006eb2a5`

## Memory Bytes
`3153303933373038372a00355130393337303834434a00355130393337303836414300355130393337303836424b003448303930373036342a00364a41393230`

## Direct References To This Address
- `PARAM` from `01168ab4` in `_INIT_138 @ 01156090`
...
- `01168a52`: `mov r1,r8`
- `01168a54`: `add r0,pc`
- `01168a56`: `ldr r6,[r0,#0x0]` refs: `READ -> 014de89c`
- `01168a58`: `mov r0,r6` refs: `PARAM -> 014f6ff4`
- `01168a5a`: `blx 0x0140be90` refs: `UNCONDITIONAL_CALL -> 0140be90`
- `01168a5e`: `b 0x01168a64` refs: `UNCONDITIONAL_JUMP -> 01168a64`
