# Data Target `00845f66`

## Symbols
- `Label` `s_1S0937086*_00845f66`

## Memory Bytes
`3153303933373038362a00355130393337303834414a003551303933373038364147003551303933373038375300355130393337303834434500355130393337`

## Direct References To This Address
- `PARAM` from `01168a94` in `_INIT_138 @ 01156090`
...
- `01168a48`: `mov r0,r8`
- `01168a4a`: `blx 0x014086e0` refs: `UNCONDITIONAL_CALL -> 014086e0`
- `01168a4e`: `movs r4,#0x0`
- `01168a50`: `ldr r0,[0x01168a60]` refs: `READ -> 01168a60`
- `01168a52`: `mov r1,r8`
- `01168a54`: `add r0,pc`
