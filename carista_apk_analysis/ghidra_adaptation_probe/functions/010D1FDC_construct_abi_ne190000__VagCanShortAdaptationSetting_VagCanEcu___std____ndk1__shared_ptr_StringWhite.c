/* std::__ndk1::allocator<VagCanShortAdaptationSetting>::construct[abi:ne190000]<VagCanShortAdaptationSetting,VagCanEcu*&,std::__ndk1::shared_ptr<StringWhitelist>,int,int,int,char_const(&)[42],std::__ndk1::shared_ptr<MultipleChoiceInterpretation>const&> @ 010d1fdc */


/* void 
   std::__ndk1::allocator<VagCanShortAdaptationSetting>::construct[abi:ne190000]<VagCanShortAdaptationSetting,
   VagCanEcu*&, std::__ndk1::shared_ptr<StringWhitelist>, int, int, int, char const (&) [42],
   std::__ndk1::shared_ptr<MultipleChoiceInterpretation> const&>(VagCanShortAdaptationSetting*,
   VagCanEcu*&, std::__ndk1::shared_ptr<StringWhitelist>&&, int&&, int&&, int&&, char const (&)
   [42], std::__ndk1::shared_ptr<MultipleChoiceInterpretation> const&) */
