/* std::__ndk1::allocator<BmwAirSuspensionOperation>::construct[abi:ne190000]<BmwAirSuspensionOperation,std::__ndk1::shared_ptr<ConnectionManager>const&,std::__ndk1::shared_ptr<BmwFGenericTool>&,std::__ndk1::shared_ptr<ReadValuesOperation>const&> @ 012b91c4 */


/* void 
   std::__ndk1::allocator<BmwAirSuspensionOperation>::construct[abi:ne190000]<BmwAirSuspensionOperation,
   std::__ndk1::shared_ptr<ConnectionManager> const&, std::__ndk1::shared_ptr<BmwFGenericTool>&,
   std::__ndk1::shared_ptr<ReadValuesOperation> const&>(BmwAirSuspensionOperation*,
   std::__ndk1::shared_ptr<ConnectionManager> const&, std::__ndk1::shared_ptr<BmwFGenericTool>&,
...
construct_abi_ne190000_<BmwAirSuspensionOperation,std::__ndk1::shared_ptr<ConnectionManager>const&,std::__ndk1::shared_ptr<BmwFGenericTool>&,std::__ndk1::shared_ptr<ReadValuesOperation>const&>
          (allocator<BmwAirSuspensionOperation> *this,BmwAirSuspensionOperation *param_1,
