/* ReadVagCanAdaptationDataCommand::getRequest @ 00d12300 */


/* ReadVagCanAdaptationDataCommand::getRequest() const */

void ReadVagCanAdaptationDataCommand::getRequest(void)
