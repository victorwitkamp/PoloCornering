/* std::__ndk1::allocator<VagUdsAdaptationSetting>::construct[abi:ne190000]<VagUdsAdaptationSetting,VagUdsEcu*&,std::__ndk1::shared_ptr<StringWhitelist>const&,short,int,int,char_const(&)[42],std::__ndk1::shared_ptr<MultipleChoiceInterpretation>const&> @ 010fbf48 */
...
/* void 
   ...
   [42], std::__ndk1::shared_ptr<MultipleChoiceInterpretation> const&>(VagUdsAdaptationSetting*,
   VagUdsEcu*&, std::__ndk1::shared_ptr<StringWhitelist> const&, short&&, int&&, int&&, char const
