/* std::__ndk1::allocator<VagUdsAdaptationSetting>::construct[abi:ne190000]<VagUdsAdaptationSetting,VagUdsEcu*&,std::__ndk1::shared_ptr<StringWhitelist>const&,int,int,std::__ndk1::vector<unsigned_char,std::__ndk1::allocator<unsigned_char>>,char_const(&)[31],std::__ndk1::shared_ptr<NumericalInterpretation>> @ 010bf090 */
...
/* void 
   ...
   std::__ndk1::vector<unsigned char, std::__ndk1::allocator<unsigned char> >, char const (&) [31],
   ...
   std::__ndk1::allocator<unsigned char> >&&, char const (&) [31],
