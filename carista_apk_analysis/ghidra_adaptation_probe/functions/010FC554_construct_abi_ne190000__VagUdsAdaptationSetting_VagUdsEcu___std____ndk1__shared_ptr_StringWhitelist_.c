/* std::__ndk1::allocator<VagUdsAdaptationSetting>::construct[abi:ne190000]<VagUdsAdaptationSetting,VagUdsEcu*&,std::__ndk1::shared_ptr<StringWhitelist>const&,short,int,int,char_const(&)[24],std::__ndk1::shared_ptr<MultipleChoiceInterpretation>const&> @ 010fc554 */
...
/* void 
   ...
   [24], std::__ndk1::shared_ptr<MultipleChoiceInterpretation> const&>(VagUdsAdaptationSetting*,
   VagUdsEcu*&, std::__ndk1::shared_ptr<StringWhitelist> const&, short&&, int&&, int&&, char const
   (&) [24], std::__ndk1::shared_ptr<MultipleChoiceInterpretation> const&) */
