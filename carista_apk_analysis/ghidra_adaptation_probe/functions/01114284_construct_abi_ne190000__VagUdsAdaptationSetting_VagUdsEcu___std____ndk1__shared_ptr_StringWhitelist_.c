/* std::__ndk1::allocator<VagUdsAdaptationSetting>::construct[abi:ne190000]<VagUdsAdaptationSetting,VagUdsEcu*&,std::__ndk1::shared_ptr<StringWhitelist>const&,short,int,std::__ndk1::vector<unsigned_char,std::__ndk1::allocator<unsigned_char>>,char_const(&)[33],std::__ndk1::shared_ptr<NumericalInterpretation>,Setting::Consistency> @ 01114284 */
...
/* void 
   ...
   std::__ndk1::vector<unsigned char, std::__ndk1::allocator<unsigned char> >, char const (&) [33],
   std::__ndk1::shared_ptr<NumericalInterpretation>, Setting::Consistency>(VagUdsAdaptationSetting*,
   VagUdsEcu*&, std::__ndk1::shared_ptr<StringWhitelist> const&, short&&, int&&,
   std::__ndk1::vector<unsigned char, std::__ndk1::allocator<unsigned char> >&&, char const (&)
   [33], std::__ndk1::shared_ptr<NumericalInterpretation>&&, Setting::Consistency&&) */
...
construct_abi_ne190000_<VagUdsAdaptationSetting,VagUdsEcu*&,std::__ndk1::shared_ptr<StringWhitelist>const&,short,int,std::__ndk1::vector<unsigned_char,std::__ndk1::allocator<unsigned_char>>,char_const(&)[33],std::__ndk1::shared_ptr<NumericalInterpretation>,Setting::Consistency>
          ...
          VagUdsEcu **param_2,shared_ptr *param_3,short *param_4,int *param_5,vector *param_6,
...

{
  ...
  *(undefined4 *)(param_8 + 4) = 0;
  VagUdsAdaptationSetting::VagUdsAdaptationSetting
            (param_1,pVVar2,param_3,sVar1,iVar3,param_6,param_7,&local_24,*(undefined4 *)param_9,2);
