/* VagUdsAdaptationSetting::toEventString @ 0118a2d4 */


/* VagUdsAdaptationSetting::toEventString() const */

void __thiscall VagUdsAdaptationSetting::toEventString(VagUdsAdaptationSetting *this)

{
  ...
  FUN_00cb4d44(abStack_20,"MCUDSAdapt_");
