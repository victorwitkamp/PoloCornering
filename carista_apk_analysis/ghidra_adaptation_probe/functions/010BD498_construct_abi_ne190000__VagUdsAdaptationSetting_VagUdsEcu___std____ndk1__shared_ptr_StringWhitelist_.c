/* std::__ndk1::allocator<VagUdsAdaptationSetting>::construct[abi:ne190000]<VagUdsAdaptationSetting,VagUdsEcu*&,std::__ndk1::shared_ptr<StringWhitelist>const&,int,int,int,char_const(&)[27],std::__ndk1::shared_ptr<MultipleChoiceInterpretation>> @ 010bd498 */
...
construct_abi_ne190000_<VagUdsAdaptationSetting,VagUdsEcu*&,std::__ndk1::shared_ptr<StringWhitelist>const&,int,int,int,char_const(&)[27],std::__ndk1::shared_ptr<MultipleChoiceInterpretation>>
...

{
  ...
  local_1c = **(undefined4 **)(FUN_010bd512 + 0x10bd4ae);
  iVar1 = *param_6;
  iVar2 = *param_4;
  pVVar3 = *param_2;
  iVar4 = *param_5;
