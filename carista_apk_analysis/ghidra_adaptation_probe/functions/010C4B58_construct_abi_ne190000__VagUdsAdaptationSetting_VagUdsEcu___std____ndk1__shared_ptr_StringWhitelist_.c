/* std::__ndk1::allocator<VagUdsAdaptationSetting>::construct[abi:ne190000]<VagUdsAdaptationSetting,VagUdsEcu*&,std::__ndk1::shared_ptr<StringWhitelist>,int,int,int,char_const(&)[41],std::__ndk1::shared_ptr<MultipleChoiceInterpretation>const&> @ 010c4b58 */
...
/* void 
   ...
   [41], std::__ndk1::shared_ptr<MultipleChoiceInterpretation> const&) */
