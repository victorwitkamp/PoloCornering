/* OperationDelegate::relearnTpms @ 012419fc */


/* OperationDelegate::relearnTpms(std::__ndk1::shared_ptr<Progress> const&, Ecu*) */

void __thiscall
OperationDelegate::relearnTpms(OperationDelegate *this,shared_ptr *param_1,Ecu *param_2)
