/* std::__ndk1::allocator<VagUdsAdaptationSetting>::construct[abi:ne190000]<VagUdsAdaptationSetting,VagUdsEcu*&,std::__ndk1::shared_ptr<StringWhitelist>const&,short,int,std::__ndk1::vector<unsigned_char,std::__ndk1::allocator<unsigned_char>>,char_const(&)[37],decltype(nullptr)> @ 01282fd8 */
...
/* void 
   ...
   char, std::__ndk1::allocator<unsigned char> >&&, char const (&) [37], decltype(nullptr)&&) */
