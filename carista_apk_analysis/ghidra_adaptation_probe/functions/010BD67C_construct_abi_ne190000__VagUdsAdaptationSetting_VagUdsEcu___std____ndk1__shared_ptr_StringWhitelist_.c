/* std::__ndk1::allocator<VagUdsAdaptationSetting>::construct[abi:ne190000]<VagUdsAdaptationSetting,VagUdsEcu*&,std::__ndk1::shared_ptr<StringWhitelist>const&,int,int,int,char_const(&)[27],std::__ndk1::shared_ptr<MultipleChoiceInterpretation>const&> @ 010bd67c */
...
/* void 
   ...
   [27], std::__ndk1::shared_ptr<MultipleChoiceInterpretation> const&) */
...

{
  ...
  local_1c = **(undefined4 **)(_FUN_010bd708 + 0x10bd694);
  uVar4 = *param_6;
  iVar5 = *param_5;
  uVar6 = *param_4;
  pVVar2 = *param_2;
