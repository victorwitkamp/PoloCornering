/* std::__ndk1::allocator<VagUdsAdaptationSetting>::construct[abi:ne190000]<VagUdsAdaptationSetting,VagUdsEcu*&,std::__ndk1::shared_ptr<StringWhitelist>,int,int,int,char_const(&)[37],std::__ndk1::shared_ptr<MultipleChoiceInterpretation>,std::__ndk1::shared_ptr<std::__ndk1::vector<unsigned_long_long,std::__ndk1::allocator<unsigned_long_long>>const>const&> @ 010dcbec */


/* void 
   std::__ndk1::allocator<VagUdsAdaptationSetting>::construct[abi:ne190000]<VagUdsAdaptationSetting,
   VagUdsEcu*&, std::__ndk1::shared_ptr<StringWhitelist>, int, int, int, char const (&) [37],
   ...
   std::__ndk1::shared_ptr<StringWhitelist>&&, int&&, int&&, int&&, char const (&) [37],
   std::__ndk1::shared_ptr<MultipleChoiceInterpretation>&&,
   std::__ndk1::shared_ptr<std::__ndk1::vector<unsigned long long, std::__ndk1::allocator<unsigned
...
construct_abi_ne190000_<VagUdsAdaptationSetting,VagUdsEcu*&,std::__ndk1::shared_ptr<StringWhitelist>,int,int,int,char_const(&)[37],std::__ndk1::shared_ptr<MultipleChoiceInterpretation>,std::__ndk1::shared_ptr<std::__ndk1::vector<unsigned_long_long,std::__ndk1::allocator<unsigned_long_long>>const>const&>
