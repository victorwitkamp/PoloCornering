/* std::__ndk1::allocator<FullByteVagCanShortAdaptationSetting>::construct[abi:ne190000]<FullByteVagCanShortAdaptationSetting,VagCanEcu*&,std::__ndk1::shared_ptr<StringWhitelist>const&,int,char_const(&)[41],decltype(nullptr)> @ 01282988 */
...
/* void 
   ...
   std::__ndk1::shared_ptr<StringWhitelist> const&, int&&, char const (&) [41], decltype(nullptr)&&)
    */
