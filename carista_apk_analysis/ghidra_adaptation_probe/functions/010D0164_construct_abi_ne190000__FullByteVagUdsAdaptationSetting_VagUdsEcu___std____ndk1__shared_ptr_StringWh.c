/* std::__ndk1::allocator<FullByteVagUdsAdaptationSetting>::construct[abi:ne190000]<FullByteVagUdsAdaptationSetting,VagUdsEcu*&,std::__ndk1::shared_ptr<StringWhitelist>,int,char_const(&)[32],std::__ndk1::shared_ptr<MultipleChoiceInterpretation>> @ 010d0164 */


/* void 
   std::__ndk1::allocator<FullByteVagUdsAdaptationSetting>::construct[abi:ne190000]<FullByteVagUdsAdaptationSetting,
   VagUdsEcu*&, std::__ndk1::shared_ptr<StringWhitelist>, int, char const (&) [32],
