/* std::__ndk1::allocator<FullByteVagUdsAdaptationSetting>::construct[abi:ne190000]<FullByteVagUdsAdaptationSetting,VagUdsEcu*&,std::__ndk1::shared_ptr<StringWhitelist>const&,int,char_const(&)[42],std::__ndk1::shared_ptr<MultipleChoiceInterpretation>> @ 010d2414 */


/* void 
   std::__ndk1::allocator<FullByteVagUdsAdaptationSetting>::construct[abi:ne190000]<FullByteVagUdsAdaptationSetting,
   VagUdsEcu*&, std::__ndk1::shared_ptr<StringWhitelist> const&, int, char const (&) [42],
