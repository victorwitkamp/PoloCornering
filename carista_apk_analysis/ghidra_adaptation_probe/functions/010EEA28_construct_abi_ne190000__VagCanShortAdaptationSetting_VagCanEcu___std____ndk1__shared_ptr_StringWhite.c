/* std::__ndk1::allocator<VagCanShortAdaptationSetting>::construct[abi:ne190000]<VagCanShortAdaptationSetting,VagCanEcu*&,std::__ndk1::shared_ptr<StringWhitelist>const&,int,int,int,char_const(&)[38],std::__ndk1::shared_ptr<MultipleChoiceInterpretation>> @ 010eea28 */
...
/* void 
   ...
   [38], std::__ndk1::shared_ptr<MultipleChoiceInterpretation>&&) */
