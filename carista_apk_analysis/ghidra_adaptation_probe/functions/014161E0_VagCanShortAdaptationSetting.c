/* VagCanShortAdaptationSetting::VagCanShortAdaptationSetting @ 014161e0 */
...
{
  VagCanShortAdaptationSetting(this,param_1,param_2,param_3,param_4,param_5,param_6,param_7,param_8)
  ;
  return;
}
