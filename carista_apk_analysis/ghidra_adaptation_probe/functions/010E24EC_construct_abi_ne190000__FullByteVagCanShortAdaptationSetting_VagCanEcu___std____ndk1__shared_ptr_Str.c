/* std::__ndk1::allocator<FullByteVagCanShortAdaptationSetting>::construct[abi:ne190000]<FullByteVagCanShortAdaptationSetting,VagCanEcu*&,std::__ndk1::shared_ptr<StringWhitelist>const&,int,char_const(&)[40],std::__ndk1::shared_ptr<MultipleChoiceInterpretation>const&> @ 010e24ec */
...
/* void 
   ...
   std::__ndk1::shared_ptr<StringWhitelist> const&, int&&, char const (&) [40],
